...
var introductionOfTheDay = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
...
intro.innerHTML = introductionOfTheDay
progress = document.getElementById('progress')
progress.value = progressValue

// progress_emoji = document.getElementById('progress_emoji')
// number_of_emoji = progressValue / 10
...
function addItemToDOM(text, completed) {
  ...
  if (completed){
    ...
    addItemToDOMSimplified(list, completed, text)
